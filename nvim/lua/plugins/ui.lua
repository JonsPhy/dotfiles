  ...
  -- Key hints
  {
    ...
    opts = {
      ...
      spec = {
        ...
        -- Leading with "quit" so it is findable — this prefix is shared with
        -- persistence sessions, molten cells and quarto preview/render.
        { "<leader>q", group = "quit/session/quarto" },
        { "<leader>r", group = "run" },
